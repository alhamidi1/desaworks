...
const id = {
  ...
  // Skills Management Tab Component
  skillsManagement: {
    title: 'Daftar Keahlian Desa',
    subtitle: 'Kelola daftar keahlian yang dapat dipilih oleh warga desa.',
    addBtn: 'Tambah Keahlian',
    addTitle: 'Tambah Keahlian Baru',
    editTitle: 'Ubah Keahlian',
    nameLabel: 'Nama Keahlian *',
    namePlaceholder: 'Contoh: Pertukangan Kayu',
    categoryLabel: 'Kategori *',
    categoryPlaceholder: 'Contoh: Konstruksi',
    descLabel: 'Keterangan (Opsional)',
    descPlaceholder: 'Tulis deskripsi keahlian...',
    cancelBtn: 'Batal',
    saveBtn: 'Simpan',
    savingBtn: 'Menyimpan...',
    deleteTitle: 'Hapus Keahlian',
    deleteConfirm: 'Apakah Anda yakin ingin menghapus keahlian ini secara permanen?',
    yesDelete: 'Ya, Hapus',
    deleting: 'Menghapus...',
    loadError: 'Gagal memuat daftar keahlian.',
    saveError: 'Gagal menyimpan keahlian.',
    deleteError: 'Gagal menghapus keahlian.',
    emptyDb: 'Belum ada keahlian di database.',
    noCategory: 'Lain-lain',
  },
} as const;
