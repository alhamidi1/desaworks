...
const en: TranslationDict = {
  ...
  skillsManagement: {
    title: 'Village Skills Directory',
    subtitle: 'Manage the list of skills that village residents can possess.',
    addBtn: 'Add Skill',
    addTitle: 'Add New Skill',
    editTitle: 'Edit Skill',
    nameLabel: 'Skill Name *',
    namePlaceholder: 'e.g. Carpentry, Masonry',
    categoryLabel: 'Category *',
    categoryPlaceholder: 'e.g. Construction, Agriculture',
    descLabel: 'Description (Optional)',
    descPlaceholder: 'Write skill description...',
    cancelBtn: 'Cancel',
    saveBtn: 'Save',
    savingBtn: 'Saving...',
    deleteTitle: 'Delete Skill',
    deleteConfirm: 'Are you sure you want to permanently delete this skill?',
    yesDelete: 'Yes, Delete',
    deleting: 'Deleting...',
    loadError: 'Failed to load skills list.',
    saveError: 'Failed to save skill.',
    deleteError: 'Failed to delete skill.',
    emptyDb: 'No skills in the database yet.',
    noCategory: 'Others',
  },
} as const;
