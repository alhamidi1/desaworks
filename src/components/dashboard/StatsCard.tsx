...
export function StatsCard({ title, value, description, hint, accent = 'neutral', icon }: StatsCardProps) {
  return (
    <article className="nm-raised p-4 transition-transform duration-200 hover:-translate-y-0.5 sm:p-5">
      ...
      <p className={`mt-2 text-2xl font-bold tracking-tight sm:text-3xl ${accentText[accent]}`}>{value}</p>
