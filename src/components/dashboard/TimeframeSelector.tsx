...
export function TimeframeSelector({ current }: { current: RangeKey }) {
  ...
  return (
    <div className="nm-inset flex w-full md:w-auto md:inline-flex gap-1 rounded-full p-1" role="group" aria-label={t('timeframe.label')}>
      {RANGES.map((r) => {
        ...
        return (
          <button
            ...
            className={`flex-1 md:flex-initial text-center min-h-[36px] rounded-full px-3 text-xs font-semibold transition ${
