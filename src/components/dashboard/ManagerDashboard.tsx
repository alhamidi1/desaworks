          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {report.projects.map((p) => (
              <Link
                ...
                className="group flex items-center justify-between rounded-2xl border border-slate-200 bg-white p-4.5 shadow-[0_2px_12px_rgba(15,23,42,0.04)] hover:border-teal-300 hover:shadow-[0_4px_20px_rgba(15,23,42,0.08)] transition-all"
              >
                ...
                <svg className="h-4 w-4 text-slate-400 group-hover:text-teal-500 shrink-0 ml-2 transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
