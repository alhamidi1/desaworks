...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-[#1e293b] transition-transform duration-200 lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex h-16 items-center gap-2.5 border-b border-slate-700 px-6">
          ...
          <span className="text-lg font-bold text-white tracking-tight">DesaWorks</span>

          {/* Close button (mobile only) */}
          <button
            onClick={() => setSidebarOpen(false)}
            className="ml-auto rounded-lg p-1.5 text-slate-400 hover:bg-slate-700 hover:text-white lg:hidden"
        ...
        <div className="border-t border-slate-700 px-6 py-4">
          <p className="text-xs text-slate-500">© 2026 DesaWorks</p>
        </div>
      </aside>
